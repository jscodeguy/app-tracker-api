...
router.get('/application', requireToken, (req, res, next) => {
	Application.find()
		.then((application) => {
			...
			console.log('this is the shown applications', application)
...
// UPDATE
// PATCH /application/5a7db6c74d55bc51bdf39793
router.patch('/application/:id', requireToken, removeBlanks, (req, res, next) => {
